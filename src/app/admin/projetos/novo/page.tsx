    ...
    <div className="w-full max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      >
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <input
                ...
                name="title"
                required
                placeholder="Ex: Coffeetery Shop"
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              name="subtitle"
              required
              placeholder="Ex: Branding and Web Design"
              className="w-full bg-black border border-zinc-800 rounded-lg p-4 text-white focus:outline-none focus:border-emerald-500 transition-colors text-sm"
            />
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <input
                ...
                name="coverImage"
                required
                placeholder="/projetos/capa.jpg"
                className="w-full bg-black border border-zinc-800 rounded-lg p-4 text-white focus:outline-none focus:border-emerald-500 transition-colors text-sm"
              />
            </div>
            <div className="space-y-2">
              <label className="text-xs uppercase tracking-widest text-zinc-500 font-bold ml-1 flex items-center gap-2">
                <ImageIcon size={14} /> Imagem About
              </label>
              <input
                type="text"
                name="aboutImage"
                required
                placeholder="/projetos/about.jpg"
                className="w-full bg-black border border-zinc-800 rounded-lg p-4 text-white focus:outline-none focus:border-emerald-500 transition-colors text-sm"
              />
            </div>
          </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full flex justify-center items-center gap-2 bg-emerald-500 text-black px-8 py-4 rounded-lg font-bold uppercase tracking-widest text-sm hover:bg-emerald-400 transition-colors shadow-lg mt-8 disabled:opacity-60"
        >
          <Save size={18} /> {loading ? "Salvando..." : "Salvar Projeto no Banco"}
        </button>
      </form>
    </div>
  );
