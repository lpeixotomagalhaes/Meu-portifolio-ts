...
export default async function About() {
  let settings: Awaited<ReturnType<typeof fetchSettings>> = null;
  ...
  const defaultText1 =
    "Olá, sou Lucas Peixoto, estudante de Ciência da Computação na Universidade de Fortaleza (Unifor). Minha jornada é guiada pela busca constante de transformar conceitos lógicos em experiências digitais intuitivas.";
  const defaultText2 =
    "Atualmente, meu foco é desenvolver interfaces web de alta performance, utilizando animações fluidas e design responsivo para garantir que a experiência do usuário (UX) seja sempre o pilar central de qualquer projeto.";
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-12 items-center">
        <div className="flex-1">
          <h3 className="text-3xl md:text-5xl font-serif italic mb-8 leading-tight">
            Minha abordagem é{" "}
            <span className="font-sans font-bold not-italic text-white">
              lógica, organizada
            </span>{" "}
            & criativa.
          </h3>
